...
ALL_CATS = {
    ...
    "hazmat": ("HAZMAT — Equipos CBRN", [
        ("trajes-nivel-a", "Trajes HAZMAT Nivel A", "NFPA 1990 / ASTM F1001", [
            ("Traje Nivel A Butilo — Ácidos", "traje-butilo-a", "Butilo", "Traje encapsulamiento total hule butilo para ácidos, bases y solventes orgánicos. Capa interior Nomex®. NFPA 1990.",
             ["Encapsulamiento total hule butilo","Resistencia ácidos, bases, solventes","Capa interior Nomex® certificada","Visor policarbonato 4 mm","NFPA 1990 / ASTM F1001"], "Ácidos · Cloruros · Solventes orgánicos"),
            ("Traje Nivel A Vitón — Hidrocarburos", "traje-viton-a", "Vitón", "Traje encapsulamiento Vitón/FKM para hidrocarburos y gases halogenados. Cremallera hermética. NFPA 1990.",
             ["Vitón/FKM encapsulamiento total","Resistencia superior hidrocarburos","Cremallera hermética certificada","Compatible SCBA externo","NFPA 1990 / EN 943-1"], "Hidrocarburos · Gases halogenados"),
            ("Traje Nivel A CBRN — Defensa Civil", "traje-cbrn-a", "CBRN", "Traje encapsulamiento CBRN para agentes químicos, biológicos, radiológicos y nucleares. NFPA 1990 clase 1.",
             ["NFPA 1990 Clase 1 CBRN total","Resistencia agentes GB, GA, GD","Sellado ZIP hermético certificado","Compatible SCBA 30 min+","NFPA 1990 / STANAG 4571"], "Defensa civil · CBRN · Terrorismo"),
            ("Traje Nivel A Desechable — Tychem 10000", "traje-desechable-a", "Desechable", "Traje encapsulamiento desechable Tychem® 10000 para primera respuesta química. Sin contaminación cruzada.",
             ["Tychem® 10000 desechable","Sin contaminación cruzada","Tallas S a 4XL disponibles","Compatible SCBA externo","NFPA 1990 / EN 943-2"], "Primera respuesta · Sin lavado"),
        ]),
        ("trajes-nivel-b", "Trajes HAZMAT Nivel B", "NFPA 1990 / EN 14605", [
            ("Traje Nivel B Tychem TK — Desechable", "traje-tychem-b", "Tychem TK", "Traje salpicaduras Tychem® TK desechable para corrosivos. Clase 3B EN 14605. Costuras termoselladas.",
             ["Tychem® TK film laminado","Resistencia corrosivos clase 3B","Desechable — sin descontaminación","Costuras termoselladas","NFPA 1990 / EN 14605"], "Derrame químico · Respuesta · Industria"),
            ("Traje Nivel B Butilo — Reutilizable", "traje-butilo-b", "Butilo", "Traje salpicaduras butilo reutilizable. 20 ciclos lavado. Para brigadas industriales con exposición frecuente.",
             ["Hule butilo reutilizable","20 ciclos lavado certificados","Resistente ácidos y álcalis","Cierre doble con guardapolvo","NFPA 1990 / EN 14605"], "Brigada industrial · Frecuencia alta"),
            ...
            ("Kit Nivel B Completo — HAZMAT", "kit-nivel-b", "Kit B", "Kit HAZMAT Nivel B completo: traje, guantes doble capa, botas goma, cinta sellado 25 m, bolsa transporte.",
             ["Traje + guantes doble capa","Botas goma resistentes químicos","Cinta sellado 25 m incluida","Bolsa transporte impermeable","NFPA 1990 / OSHA 1910.120"], "Primera respuesta · Kit completo"),
        ]),
        ("trajes-nivel-c", "Trajes HAZMAT Nivel C", "EN 13034 / NFPA 1990", [
            ...
            ("Traje Tychem C — Avanzado", "traje-tychem-c", "Tychem C", "Traje Tychem® C doble capa para salpicaduras riesgo moderado. Clase 3B. Costuras termoselladas.",
             ["Tychem® C film barrera dual","Clase 3B EN 14605","Costuras termoselladas","Tallas S a 4XL disponibles","EN 14605 / NFPA 1990"], "Industria química · Laboratorio"),
            ("Traje Tyvek 500 — Alto Rendimiento", "traje-tyvek-500", "Tyvek 500", "Traje Tyvek® 500 reforzado para mayor durabilidad. 2× resistencia a rasgado vs básico. Trabajo prolongado.",
             ["Tyvek® 500 reforzado abrasión","Resistencia rasgado 2× básico","Costuras selladas áreas críticas","Clase 5/6 EN 13034","EN 13034 / NFPA 1990"], "Trabajo prolongado · Exteriores"),
        ...
        ("comunicaciones-hazmat", "Comunicaciones HAZMAT", "ATEX / ETSI TETRA", [
            ...
            ("Intercomunicador Traje Nivel A", "intercom-nivel-a", "Nivel A", "Intercomunicador externo para trajes encapsulamiento Nivel A. 24 dB amplificación. Batería 24 h. Universal.",
             ["Micrófono exterior al traje","Amplificación 24 dB voz","Alimentación batería 24 h","Montaje universal nivel A","NFPA 1990 / ATEX compatible"], "Dentro del traje Nivel A · Comunicación"),
    ...
    "herramientas-rescate": ("Herramientas de Rescate", [
        ...
        ("equipos-apuntalamiento", "Equipos de Apuntalamiento", "NFPA 2500 / Paratech", [
            ("Sistema Apuntalamiento Estructural — Paratech", "apuntalamiento-paratech", "Paratech", "Sistema apuntalamiento estructural Paratech con puntales neumáticos 1–5 ton. Para derrumbes y estructuras inestables.",
             ["Puntales neumáticos 1–5 ton","Extensión: 60 cm a 3.6 m","Presión trabajo: 8 bar","Kit completo 4 puntales","NFPA 2500 / Paratech"], "Derrumbes · Estructuras inestables"),
            ("Puntales de Madera — Kit Shore", "puntales-madera", "Shore Kit", "Kit de apuntalamiento con puntales de madera (4×4 y 4×6) y accesorios. Para estabilización en rescate urbano.",
             ["Madera tratada 4×4 y 4×6","Cuñas y bases de distribución","Clavos de apuntalamiento 16d","Manual técnico NFPA 2500","NFPA 2500 / ASTM D245"], "Rescate urbano · Estabilización básica"),
            ("Strut System — Estabilización Vehicular", "strut-vehicular", "Strut", "Sistema de struts para estabilización vehicular: 3 puntales telescópicos con base magnética y cabezal ajustable.",
             ["3 puntales telescópicos ajustables","Base magnética de 50 kg fuerza","Cabezal articulado 360°","Capacidad: 10 ton por strut","NFPA 2500 / EN 13204"], "Extricación vehicular · Estabilización"),
            ("Cribbing Blocks — Juego 18 Piezas", "cribbing-blocks", "Cribbing", "Juego de 18 bloques de cribbing de polímero reciclado para apuntalamiento y nivelación. Resistente a aceites.",
             ["18 bloques polímero reciclado","Resistente aceites y combustible","Capacidad: 25 ton por stack","No absorbe agua","NFPA 2500"], "Nivelación · Apuntalamiento · Cribbing"),
        ]),
        ("airbags-elevacion", "Airbags de Elevación", "NFPA 2500 / EN 13731", [
            ("Airbag Alta Presión — 20 ton", "airbag-alta-20ton", "20 ton", "Airbag de alta presión 20 ton para elevación y separación en rescate. 8 bar. Neopreno reforzado con Kevlar.",
             ["Capacidad: 20 ton a 8 bar","Neopreno reforzado Kevlar","Altura elevación: 5–30 cm","Regulador presión incluido","NFPA 2500 / EN 13731"], "Rescate vehicular · Elevación · Separación"),
            ("Airbag Alta Presión — 40 ton", "airbag-alta-40ton", "40 ton", "Airbag alta presión 40 ton para rescate pesado. Elevación estructural y vehicular. Controlador dual incluido.",
             ["Capacidad: 40 ton a 8 bar","Controlador dual regulado","Altura elevación: 10–50 cm","Peso: 12 kg vacío","NFPA 2500 / EN 13731"], "Rescate pesado · Estructura · Vehículo grande"),
            ("Airbag Baja Presión — 1 bar", "airbag-baja-1bar", "Baja presión", "Airbag baja presión 1 bar para elevación suave y estabilización de cargas sensibles. Gran superficie de contacto.",
             ["Baja presión: 1 bar máximo","Gran superficie de contacto","Elevación suave y controlada","Capacidad: 5–15 ton","NFPA 2500 / EN 13731"], "Elevación suave · Cargas sensibles"),
            ("Kit Airbags — Sistema Completo", "kit-airbags", "Kit", "Kit completo de airbags: 2 alta presión (20+40 ton) + controlador dual + mangueras + bolsa transporte. NFPA 2500.",
             ["2 airbags: 20 + 40 ton","Controlador dual con regulador","Mangueras 10 m incluidas","Bolsa transporte Cordura","NFPA 2500 / EN 13731"], "Kit completo · Rescate · Operaciones"),
        ]),
        ...
        ("cuerdas-sistemas", "Cuerdas y Sistemas de Rescate", "NFPA 2500 / EN 1891", [
            ("Cuerda Estática Kernmantle 11 mm — NFPA", "cuerda-estatica-11mm", "11 mm", "Cuerda estática kernmantle 11 mm certificada NFPA 2500 para rescate. Poliamida 6.6. Resistencia 30 kN.",
             ["Kernmantle 11 mm poliamida 6.6","Resistencia rotura: 30 kN","Elongación: < 3% a 10% carga","Longitudes: 30, 60, 100, 200 m","NFPA 2500 / EN 1891 Tipo A"], "Rescate vertical · Rappel · Descenso"),
            ("Polea Doble — Rescate 4:1", "polea-doble-rescate", "Polea 4:1", "Polea doble para sistema de ventaja mecánica 4:1 en rescate. Placa de aluminio 7075. Carga 40 kN.",
             ["Carga trabajo: 40 kN (MBS)","Placa aluminio 7075 forjado","Rodamientos sellados inox","Diámetro polea: 50 mm","NFPA 2500 / EN 12278"], "Rescate vertical · Ventaja mecánica"),
            ("Descensor de Rack — Freno Variable", "descensor-rack", "Rack", "Descensor de rack con 6 barras para rappel controlado. Disipación de calor superior. Carga 250 kg persona.",
             ["6 barras de acero inoxidable","Carga persona: 250 kg","Disipación calor por convección","Compatible cuerdas 10–13 mm","NFPA 2500 / EN 341"], "Rappel · Descenso controlado · Evacuación"),
            ("Kit Cuerdas Rescate — Sistema Completo", "kit-cuerdas-rescate", "Kit", "Kit sistema de cuerdas para rescate: 2 cuerdas 60 m, poleas, descensor, mosquetones, bolsa y manual.",
             ["2 cuerdas estáticas 60 m × 11 mm","2 poleas dobles + mosquetones HMS","Descensor rack + freno de seguridad","Bolsa transporte 60 L","NFPA 2500 / EN 1891"], "Kit completo · Rescate vertical · Equipo"),
        ]),
    ]),
    # ── 6. RESCATE ACUÁTICO ────────────────────────────────────────────────
    "rescate-acuatico": ("Rescate Acuático", [
        ...
        ("tablas-rescate", "Tablas de Rescate Acuático", "NFPA 1952 / USCG", [
            ...
            ("Sled de Rescate — Hielo/Agua", "sled-rescate-hielo", "Sled", "Sled de rescate para hielo y agua abierta. Superficie antiderrapante. Asas de arrastre. 200 kg carga.",
             ["Polietileno alta densidad","Carga: 200 kg máximo","Superficie antiderrapante","Asas arrastre 4 puntos","NFPA 2500 / USCG"], "Hielo · Agua abierta · Rescate estático"),
