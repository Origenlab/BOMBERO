...
def std_related_3(cat_slug, cat_label, exclude_subcat=""):
    cats = [
        {"title": "Trajes de Bombero", "badge": "NFPA 1970", "desc": "Trajes estructurales y forestales certificados.", "href": "/productos/trajes-para-bomberos/", "btn": "Ver Trajes", "img": "/images/base/traje-estructural.avif"},
        {"title": "Cascos para Bombero", "badge": "NFPA 1970", "desc": "Cascos estructurales y de rescate certificados.", "href": "/productos/cascos-para-bomberos/", "btn": "Ver Cascos", "img": "/images/base/casco-estructural.avif"},
        {"title": "SCBA Autónomo", "badge": "NFPA 1970", "desc": "Equipos de respiración autónoma certificados.", "href": "/productos/scba/", "btn": "Ver SCBA", "img": "/images/base/equipo-completo.avif"},
...
GENERIC_CATS = [
    ("scba", "SCBA — Respiración Autónoma", "/productos/scba/", [
        ("circuito-abierto-nfpa-1981", "SCBA Circuito Abierto NFPA 1970",
         "SCBA · NFPA 1970 · 30/45/60 min", "SCBA Circuito Abierto", "NFPA 1970",
         "Equipos de respiración autónoma SCBA circuito abierto para bomberos. 30, 45 y 60 minutos a 40 L/min. Cilindros de carbono 300 bar. Certificados NFPA 1970 y EN 137.",
         "Cotizar SCBA NFPA 1970", 0,
         [
             ("scba-30min","SCBA 30 min — Circuito Abierto","30 min","smoke","SCBA de circuito abierto 30 min a 40 L/min con cilindro de fibra de carbono 6.0 L 300 bar. Máscara panorámica incluida. NFPA 1970.",
              ["Cilindro carbono 6.0 L 300 bar","Duración: 30 min @ 40 L/min","Máscara panorámica NFPA 1970","Arnés ajustable multitalla","NFPA 1970 / EN 137"],
             ...
             ("scba-45min","SCBA 45 min — Estándar","45 min","fire","SCBA de circuito abierto 45 min estándar para operaciones de incendio estructural. Cilindro 6.8 L carbono 300 bar. Visor HUD integrado.",
              ["Cilindro carbono 6.8 L 300 bar","Duración: 45 min @ 40 L/min","HUD display presión integrado","Arnés ergonómico con soporte lumbar","NFPA 1970 / EN 137"],
              "Estructural · HAZMAT · Rescate urbano"),
             ("scba-60min","SCBA 60 min — Larga Duración","60 min","ember","SCBA 60 min para operaciones de larga duración y ambientes IDLH extendidos. Cilindro 9.0 L carbono 300 bar. NFPA 1970.",
              ["Cilindro carbono 9.0 L 300 bar","Duración: 60 min @ 40 L/min","Sistema de alarma PASS integrado","RIC-PAC compatible","NFPA 1970 / EN 137 / EN 402"],
             ...
             ("scba-45min-panoramico","SCBA 45 min — Máscara Panorámica","45 min","smoke","SCBA 45 min con máscara facial panorámica de visibilidad amplia. Campo visual 220°. Compatible con sistemas de comunicación TETRA.",
              ["Máscara panorámica 220° campo visual","Cilindro 6.8 L 300 bar carbono","Compatible com comunicación TETRA","Válvula de demanda certificada","NFPA 1970 / EN 136"],
        ...
        ("mascara-facial", "Máscaras Faciales para SCBA",
         "Máscara · Panorámica · NFPA 1970 / EN 136", "Máscaras Faciales", "HUD Integrado",
         "Máscaras faciales panorámicas para SCBA con HUD display integrado. Visor de policarbonato 220°, válvula de demanda certificada. NFPA 1970 y EN 136.",
         "Cotizar Máscaras Faciales SCBA", 2,
         [
             ("mascara-panoramica","Máscara Panorámica — Policarbonato","220°","fire","Máscara facial panorámica de policarbonato 220° para SCBA. Compatible con todos los reguladores NFPA 1970. Sello de silicona de baja presión.",
              ["Visor panorámico PC 220°","Sello de silicona baja presión","Compatible SCBA universal","Protección UV y anti-rayado","NFPA 1970 / EN 136 / EN 14387"],
              "SCBA · Incendio estructural · HAZMAT"),
             ("mascara-hud","Máscara con HUD — Display Digital","HUD","ember","Máscara con HUD display digital integrado en visor. Muestra presión del cilindro, tiempo restante y alertas PASS. NFPA 1970.",
              ["HUD display presión en tiempo real","Alertas visuales tiempo restante","Pantalla integrada en visor","Compatible con cilindros 300 bar","NFPA 1970 / EN 136"],
             ...
             ("mascara-reutilizable","Máscara Reutilizable — Mantenimiento Fácil","Multi-uso","smoke","Máscara facial reutilizable de bajo mantenimiento. Visor reemplazable, arnés ajustable y válvulas de exhale intercambiables.",
              ["Visor reemplazable individual","Arnés ajustable 4 puntos","Válvulas de exhale intercambiables","Esterilizable con solución NaOCl 0.5%","NFPA 1970 / EN 136"],
        ...
        ("cilindros-repuesto", "Cilindros de Repuesto SCBA",
         ...
         "Cilindros de repuesto para SCBA: fibra de carbono 6.0, 6.8 y 9.0 L a 300 bar. También aluminio 6.8 L 200 bar. Certificados DOT/TC, EN 12245 y NFPA 1970.",
         "Cotizar Cilindros SCBA", 3,
         [
             ("cilindro-6l-300bar","Cilindro Carbono 6.0 L 300 bar","6.0 L","smoke","Cilindro de fibra de carbono 6.0 L 300 bar para SCBA 30 min. Peso 1.5 kg vacío. Compatible con todos los fabricantes NFPA 1970.",
              ["Fibra de carbono 6.0 L 300 bar","Peso vacío: 1.5 kg","Duración: 30 min @ 40 L/min","Compatible NFPA 1970 universal","DOT/TC / EN 12245 / ISO 11119-3"],
             ...
             ("cilindro-9l-300bar","Cilindro Carbono 9.0 L 300 bar","9.0 L","fire","Cilindro de fibra de carbono 9.0 L 300 bar para SCBA 60 min. Máxima capacidad estándar. Peso 2.4 kg vacío.",
              ["Fibra de carbono 9.0 L 300 bar","Peso vacío: 2.4 kg","Duración: 60 min @ 40 L/min","Rosca de conexión M18×1.5","DOT/TC / EN 12245 / NFPA 1970"],
             ...
             ("cilindro-carbono-9l","Cilindro Carbono 6.8 L 300 bar","6.8 L","ember","Cilindro de fibra de carbono 6.8 L 300 bar para SCBA 45 min. El modelo más vendido. Compatible universalmente con NFPA 1970.",
              ["Fibra de carbono 6.8 L 300 bar","Duración: 45 min @ 40 L/min","Peso vacío: 1.8 kg — ultraligero","Rosca M18×1.5 universal","DOT/TC / EN 12245 / NFPA 1970"],
        ...
        ("sistemas-comunicacion", "Sistemas de Comunicación para SCBA",
         ...
         [
             ("radio-integrado-scba","Radio Integrado en Máscara — TETRA","TETRA","fire","Sistema de radio TETRA integrado en máscara SCBA. Comunicación full-duplex con el puesto de mando. Compatible con máscaras NFPA 1970.",
              ["Radio TETRA integrado en máscara","Full-duplex manos libres","Compatible NFPA 1970 universal","Resistente agua IP67","NFPA 1970 / ETSI TETRA"],
             ...
             ("amplificador-voz","Amplificador de Voz para Máscara","Voz","smoke","Amplificador de voz electrónico para máscaras SCBA. Convierte el habla a través de la máscara en comunicación inteligible. No requiere radio.",
              ["Amplificación 18 dB de voz","Montaje exterior máscara estándar","Pila AA 100+ horas","Sin configuración — plug & play","EN 136 / NFPA 1970 compatible"],
        ...
        ("soporte-comando", "Soporte de Comando y RIC-PAC",
         "RIC-PAC · Comando · NFPA 1970", "Soporte de Comando", "RIC-PAC",
         ...
         [
             ("ricpac-scba","RIC-PAC — Rescate Rápido Bombero Atrapado","RIC-PAC","fire","El RIC-PAC es el SCBA de rescate para el bombero atrapado. 15 min de emergencia, conexión rápida con manguera de 3 m. NFPA 1970.",
              ["SCBA emergencia 15 min","Manguera de transfusión 3 m","Acople rápido con SCBA del atrapado","Peso: < 4 kg listo para uso","NFPA 1970 / NFPA 1710"],
             ...
             ("maletero-rescate","Maletero RIT — Kit de Rescate Rápido","RIT","ember","Maletero de rescate RIT (Rapid Intervention Team) con RIC-PAC, cuerda guía y herramientas básicas de desorientación.",
              ["RIC-PAC + cuerda guía 30 m","Herramientas de extricación ligera","Maletero rugged de polietileno","Despliegue completo en < 60 s","NFPA 1970 / NFPA 1710 / NFPA 1407"],
             ...
             ("soporte-emergencia","Transmisor de Alarma PASS — Integrado","PASS","fire","Dispositivo PASS (Personal Alert Safety System) de activación automática para bombero atrapado. Alarma audible 95 dB y visual. NFPA 1970.",
              ["Alarma PASS 95 dB certificada","Activación automática 30 s inmovilidad","Modo manual de emergencia","Integrable con radio TETRA","NFPA 1970 / EN 61000"],
        ...
        ("mantenimiento-recarga", "Mantenimiento y Recarga de SCBA",
         ...
         [
             ...
             ("kit-mantenimiento","Kit de Mantenimiento SCBA — Completo","Kit","smoke","Kit de mantenimiento y revisión anual para SCBA: herramientas de torque, lubricante certificado, O-rings y checklist de inspección.",
              ["Herramientas de torque calibradas","Lubricante certificado Molykote®","O-rings de reemplazo Viton®","Checklist de inspección NFPA 1970","NFPA 1970 / EN 137"],
             ...
             ("probador-presion","Probador de Presión y Caudal — Test SCBA","Test","smoke","Instrumento de prueba de presión y caudal para verificación de SCBA. Mide caudal, presión de demanda y hermeticidad de máscara.",
              ["Prueba de caudal y presión","Verificación hermeticidad máscara","Calibrado trazable NIST/CENAM","Almacenamiento de resultados","NFPA 1970 / EN 137"],
    ...
    ("hazmat", "HAZMAT — Equipos CBRN", "/productos/hazmat/", [
        ("trajes-nivel-a", "Trajes HAZMAT Nivel A",
         "Nivel A · NFPA 1990 · Encapsulado", "Trajes Nivel A", "Encapsulamiento Total",
         "Trajes de encapsulamiento total Nivel A para protección contra gases y vapores peligrosos. NFPA 1990 y ASTM F1001. Completamente herméticos.",
         "Cotizar Trajes Nivel A HAZMAT", 1,
         [
             ("traje-nivel-a-butilo","Traje Nivel A Butilo — Gases Ácidos","Butilo","fire","Traje de encapsulamiento total de hule butilo para ácidos, bases y solventes orgánicos. NFPA 1990. Capa interior de Nomex para protección adicional.",
              ["Encapsulamiento total hule butilo","Resistencia ácidos, bases, solventes","Capa interior Nomex® certificada","Visor de policarbonato 4 mm","NFPA 1990 / ASTM F1001"],
              "Ácidos · Cloruros · Solventes orgánicos"),
             ("traje-nivel-a-viton","Traje Nivel A Vitón — Hidrocarburos","Vitón","ember","Traje de encapsulamiento total de Vitón/FKM para hidrocarburos, gases halogenados y productos químicos agresivos. NFPA 1990.",
              ["Vitón/FKM encapsulamiento total","Resistencia superior a hidrocarburos","Certificado EN 943-1 Tipo 1A","Cremallera hermética NFPA 1990","NFPA 1990 / EN 943-1"],
              "Hidrocarburos · Gases halogenados"),
             ("traje-nivel-a-cbrn","Traje Nivel A CBRN — Defensa Civil","CBRN","smoke","Traje de encapsulamiento total para agentes CBRN (químico, biológico, radiológico y nuclear). NFPA 1990 clase 1. Compatible con SCBA.",
              ["NFPA 1990 Clase 1 CBRN","Resistencia a agentes GB, GA, GD","Sellado ZIP hermético certificado","Compatible SCBA 30 min+","NFPA 1990 / STANAG 4571"],
             ...
             ("traje-nivel-a-desechable","Traje Nivel A Desechable — Respuesta","Desechable","smoke","Traje de encapsulamiento desechable de Tychem® 10000 para primera respuesta química. Sin contaminación cruzada.",
              ["Tychem® 10000 desechable","Sin contaminación cruzada","Disponible tallas S a 4XL","Compatible SCBA externo","NFPA 1990 / EN 943-2"],
              "Primera respuesta · Sin lavado"),
         ]),
        ("trajes-nivel-b", "Trajes HAZMAT Nivel B",
         "Nivel B · NFPA 1990 · Salpicaduras", "Trajes Nivel B", "Sin Encapsulamiento",
         "Trajes HAZMAT Nivel B para protección contra salpicaduras de líquidos peligrosos sin encapsulamiento. NFPA 1990 y EN 14605. Para primera respuesta.",
         ...
         [
             ("traje-nivel-b-tychem","Traje Nivel B Tychem® TK — Desechable","Tychem TK","smoke","Traje de salpicaduras Tychem® TK desechable de DuPont. Resistencia superior a productos corrosivos. Clase 3B EN 14605.",
              ["Tychem® TK film laminado","Resistencia corrosivos clase 3B","Desechable — sin descontaminación","Costuras termoselladas","NFPA 1990 / EN 14605 Tipo 3B"],
             ...
             ("traje-nivel-b-reutilizable","Traje Nivel B Butilo Reutilizable","Butilo","ember","Traje de salpicaduras de hule butilo reutilizable. Lavable hasta 20 ciclos. Ideal para brigadas industriales con exposición frecuente.",
              ["Hule butilo reutilizable","Resistente a ácidos y álcalis","20 ciclos de lavado certificados","Cierre doble con guardapolvo","NFPA 1990 / EN 14605"],
             ...
             ("conjunto-nivel-b","Conjunto Nivel B Completo — Kit HAZMAT","Kit B","fire","Kit HAZMAT Nivel B completo: traje, guantes exterior/interior, botas de goma, cinta de sellado y bolsa de transporte.",
              ["Traje + guantes doble capa","Botas de goma resistentes","Cinta de sellado 25 m incluida","Bolsa de transporte impermeable","NFPA 1990 / OSHA 1910.120"],
        ...
        ("trajes-nivel-c", "Trajes HAZMAT Nivel C",
         ...
         [
             ...
             ("traje-nivel-c-tychem","Traje Tychem® C — Nivel C Avanzado","Tychem C","ember","Traje Tychem® C de doble capa para exposición a salpicaduras de productos químicos de riesgo moderado. Clase 3B.",
              ["Tychem® C film barrera dual","Clase 3B EN 14605","Costuras termoselladas","Talla S a 4XL disponible","EN 14605 / NFPA 1990"],
             ...
             ("traje-nivel-c-dupont","Traje Tyvek® 500 — Alto Rendimiento","Tyvek 500","fire","Traje Tyvek® 500 reforzado para mayor durabilidad. Resistencia superior a abrasión y rasgado. Para trabajo prolongado.",
              ["Tyvek® 500 reforzado abrasión","Resistencia rasgado 2× básico","Costuras selladas en áreas críticas","Clase 5/6 EN 13034","EN 13034 / NFPA 1990"],
        ...
        ("comunicaciones-hazmat", "Comunicaciones para HAZMAT",
         ...
         [
             ...
             ("intercomunicador-hazmat","Intercomunicador para Traje Nivel A","Nivel A","smoke","Sistema de comunicación con micrófono externo para trajes de encapsulamiento Nivel A. Permite comunicación sin quitar el traje.",
              ["Micrófono exterior al traje","Amplificación 24 dB de voz","Alimentación batería 24 h","Montaje universal nivel A","NFPA 1990 / ATEX compatible"],
