const estacionesCDMX = [
  ...
  },
  {
    ...
    horario: "24 horas",
    coordenadas: { lat: 19.436, lng: -99.0719 },
...
function getEstacionesCercanas(slug, limit = 3) {
  ...
  if (!estacion) return [];
  return estacionesCDMX.filter((e) => e.slug !== slug).slice(0, limit);
}

export { getEstacionesCercanas as a, getAlcaldias as b, estacionesCDMX as e, getEstacionBySlug as g };
