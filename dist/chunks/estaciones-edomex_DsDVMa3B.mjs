...
function getEstacionesCercanas(slug, limit = 3) {
  ...
  if (!estacion) return [];
  return estacionesEdoMex.filter((e) => e.slug !== slug).slice(0, limit);
}

export { getEstacionesCercanas as a, estacionesEdoMex as e, getEstacionBySlug as g };
