const estacionesAguascalientes = [
  {
    id: "ags-central",
  ...
  },
  {
    ...
    horario: "24 horas",
    coordenadas: { lat: 21.9236, lng: -102 },
  ...
  },
  {
    ...
    horario: "24 horas",
    coordenadas: { lat: 22.15, lng: -102.4167 },
...
function getEstacionesCercanas(slug, limit = 3) {
  ...
  if (!estacion) return [];
  return estacionesAguascalientes.filter((e) => e.slug !== slug).slice(0, limit);
}

export { getEstacionesCercanas as a, getMunicipios as b, estacionesAguascalientes as e, getEstacionBySlug as g };
