...
import { e as estacionesColima, E as ESTADISTICAS_COLIMA } from '../../chunks/estaciones-colima_DwJfgul0.mjs';
import { b as breadcrumbJsonLd } from '../../chunks/PageLayout_C37tG6Zv.mjs';
export { renderers } from '../../renderers.mjs';

const $$Colima = createComponent(($$result, $$props, $$slots) => {
  const estadosVecinos = getEstadosVecinos("colima");
  ...
  const stationImages = [
    ...
    "/images/directorio/escudo-frontal-casco-bomberos-cuero-01.avif",
    "/images/directorio/bombero-equipandose-cuartel-central-01.avif"
  ];
  ...
  ], "estadosVecinos": estadosVecinos, "estaciones": estacionesColima, "stationImages": stationImages, "eppCards": [
    {
