...
import { e as estacionesHidalgo, E as ESTADISTICAS_HIDALGO, H as HIDALGO_SEO } from '../../chunks/estaciones-hidalgo_CzNOQ97m.mjs';
...
const $$Hidalgo = createComponent(($$result, $$props, $$slots) => {
  ...
  const eppCards = [
    ...
    },
    {
      ...
      imgSrc: "/images/directorio/traje-bombero-estructural-nfpa-01.avif",
  ...
  const stationImages = estacionesHidalgo.map((_, idx) => ({
