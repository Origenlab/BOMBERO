...
import { g as getEstacionBySlug, a as getEstacionesCercanas, e as estacionesSonora } from '../../../chunks/estaciones-sonora_BVABIGBT.mjs';
/* empty css                                        */
...
const $$slug = createComponent(($$result, $$props, $$slots) => {
  ...
  const seoDescription = `${truncateForSEO(estacion.descripcion || "", 120)} Tel: ${estacion.telefono}. ${ubicacion}, Sonora.`;
  const stationJsonLd = {
...
<a href="/productos/cascos-para-bomberos" data-astro-cid-kd3jbsf2>cascos certificados</a>, <a href="/productos/guantes-para-bomberos" data-astro-cid-kd3jbsf2>guantes</a> y
<a href="/productos/botas-para-bomberos" data-astro-cid-kd3jbsf2>botas certificadas</a>.
