...
import { e as estacionesCoahuila, E as ESTADISTICAS_COAHUILA } from '../../chunks/estaciones-coahuila_tiSeyW-1.mjs';
import { b as breadcrumbJsonLd } from '../../chunks/PageLayout_C37tG6Zv.mjs';
export { renderers } from '../../renderers.mjs';

const $$Coahuila = createComponent(($$result, $$props, $$slots) => {
  const estadosVecinos = getEstadosVecinos("coahuila");
  ...
  const stationImages = [
    ...
    "/images/directorio/estacion-bomberos-guardia-nocturna-01.avif"
  ];
  ...
  ], "estadosVecinos": estadosVecinos, "estaciones": estacionesCoahuila, "stationImages": stationImages, "eppCards": [
    {
