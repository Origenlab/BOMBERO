...
import { c as getMunicipios, d as getEstadisticas, e as estacionesBajaCaliforniaSur } from '../../chunks/estaciones-baja-california-sur_CEvlAvrM.mjs';
...
const $$BajaCaliforniaSur = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "estaciones": estacionesBajaCaliforniaSur, "stationImages": stationImages, "eppCards": [
    {
