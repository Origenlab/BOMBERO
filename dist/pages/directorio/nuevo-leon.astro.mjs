...
import { e as estacionesNuevoLeon, b as getMunicipios } from '../../chunks/estaciones-nuevo-leon_CKUgyJsb.mjs';
/* empty css                                         */
...
const $$NuevoLeon = createComponent(($$result, $$props, $$slots) => {
  ...
  const stationImages = [
    ...
    "/images/directorio/bomberos-equipandose-turno-estacion-01.avif"
  ];
  const heroThumbs = [
    {
  ...
  const estadosVecinos = getEstadosVecinos("nuevo-leon");
  const regiones = [
    {
