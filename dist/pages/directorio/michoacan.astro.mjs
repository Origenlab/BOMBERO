...
import { b as getMunicipios, e as estacionesMichoacan } from '../../chunks/estaciones-michoacan_R2UcYaBV.mjs';
...
const $$Michoacan = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "estaciones": estacionesMichoacan, "stationImages": stationImages, "eppCards": [
    {
