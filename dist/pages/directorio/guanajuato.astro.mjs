...
import { e as estacionesGuanajuato, E as ESTADISTICAS_GUANAJUATO } from '../../chunks/estaciones-guanajuato_B9RFEGiK.mjs';
...
const $$Guanajuato = createComponent(($$result, $$props, $$slots) => {
  ...
  const stationImages = estacionesGuanajuato.map((_, idx) => ({
