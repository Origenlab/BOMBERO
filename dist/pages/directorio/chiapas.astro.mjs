...
import { c as getMunicipios, d as getEstadisticas, e as estacionesChiapas } from '../../chunks/estaciones-chiapas_BGEiizh-.mjs';
...
const $$Chiapas = createComponent(($$result, $$props, $$slots) => {
  ...
  ], "estaciones": estacionesChiapas, "stationImages": stationImages, "eppCards": [
    {
