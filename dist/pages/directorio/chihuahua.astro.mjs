...
import { e as estacionesChihuahua, E as ESTADISTICAS_CHIHUAHUA } from '../../chunks/estaciones-chihuahua_NvV-0Zbp.mjs';
...
const $$Chihuahua = createComponent(($$result, $$props, $$slots) => {
  const estadosVecinos = getEstadosVecinos("chihuahua");
  ...
  const stationImages = [
    ...
    "/images/directorio/chaqueton-bombero-estructural-hebillas-01.avif"
  ];
  ...
  ], "estadosVecinos": estadosVecinos, "estaciones": estacionesChihuahua, "stationImages": stationImages, "eppCards": [
    {
