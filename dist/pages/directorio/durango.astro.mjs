...
import { e as estacionesDurango, E as ESTADISTICAS_DURANGO } from '../../chunks/estaciones-durango_ho32asa4.mjs';
import { b as breadcrumbJsonLd } from '../../chunks/PageLayout_C37tG6Zv.mjs';
export { renderers } from '../../renderers.mjs';

const $$Durango = createComponent(($$result, $$props, $$slots) => {
  const estadosVecinos = getEstadosVecinos("durango");
  ...
  const stationImages = [
    ...
    "/images/directorio/bomberos-preparacion-salida-emergencia-01.avif"
  ];
  ...
  ], "estadosVecinos": estadosVecinos, "estaciones": estacionesDurango, "stationImages": stationImages, "eppCards": [
    {
