...
import { b as getMunicipios, c as getEstadisticas, e as estacionesCampeche } from '../../chunks/estaciones-campeche_BYM6RbR7.mjs';
import { b as breadcrumbJsonLd } from '../../chunks/PageLayout_C37tG6Zv.mjs';
export { renderers } from '../../renderers.mjs';

const $$Campeche = createComponent(($$result, $$props, $$slots) => {
  const estadosVecinos = getEstadosVecinos("campeche");
  ...
  const stationImages = [
    ...
    "/images/directorio/bombero-pantalon-bunker-vestidor-01.avif"
  ];
  ...
  ], "estadosVecinos": estadosVecinos, "estaciones": estacionesCampeche, "stationImages": stationImages, "eppCards": [
    {
