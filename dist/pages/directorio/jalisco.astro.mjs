...
import { b as getMunicipios, e as estacionesJalisco } from '../../chunks/estaciones-jalisco_BxLUtx_q.mjs';
import { b as breadcrumbJsonLd } from '../../chunks/PageLayout_C37tG6Zv.mjs';
export { renderers } from '../../renderers.mjs';

const $$Jalisco = createComponent(($$result, $$props, $$slots) => {
  const estadosVecinos = getEstadosVecinos("jalisco");
  ...
  const stationImages = [
    ...
    "/images/directorio/estacion-bomberos-moderna-01.avif",
    "/images/directorio/bomberos-accion-incendio-01.avif",
    "/images/directorio/bombero-vestidor-preparacion-guardia-01.avif"
  ];
  ...
  ], "estadosVecinos": estadosVecinos, "estaciones": estacionesJalisco, "stationImages": stationImages, "eppCards": [
    {
