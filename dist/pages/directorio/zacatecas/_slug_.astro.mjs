...
const $$slug = createComponent(($$result, $$props, $$slots) => {
  ...
  const seoDescription = `${truncateForSEO(estacion.descripcion || "", 120)} Tel: ${estacion.telefono}. ${ubicacion}, Zacatecas.`;
  const stationJsonLd = {
