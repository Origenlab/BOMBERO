...
import { Z as ZONAS_VERACRUZ, g as getEstacionesPorZona, a as getAlertaHuracanActual, P as PROTOCOLOS_VERACRUZ, b as getInstalacionesPEMEX, c as getPuertos, F as FAQ_VERACRUZ, e as estacionesVeracruz, S as SISTEMA_HURACANES_VERACRUZ } from '../../../chunks/estaciones-veracruz_jltBKbHh.mjs';
/* empty css                                        */
...
const $$slug = createComponent(($$result, $$props, $$slots) => {
  ...
  const ubicacion = estacion.municipiosCubiertos?.[0] || "Veracruz";
  const seoDescription = `${truncateForSEO(estacion.descripcion || "", 120)} Tel: ${estacion.telefono}. ${ubicacion}, Veracruz.`;
