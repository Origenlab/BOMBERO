...
import { b as getMunicipios, e as estacionesMorelos } from '../../chunks/estaciones-morelos_BX6uE4Vd.mjs';
import { b as breadcrumbJsonLd } from '../../chunks/PageLayout_C37tG6Zv.mjs';
export { renderers } from '../../renderers.mjs';

const $$Morelos = createComponent(($$result, $$props, $$slots) => {
  const estadosVecinos = getEstadosVecinos("morelos");
  ...
  const stationImages = [
    ...
    "/images/directorio/bombero-vestidor-preparacion-guardia-02.avif"
  ];
  ...
  ], "estadosVecinos": estadosVecinos, "estaciones": estacionesMorelos, "stationImages": stationImages, "eppCards": [
    {
