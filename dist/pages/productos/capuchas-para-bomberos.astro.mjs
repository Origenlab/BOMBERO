...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const productos = [
    ...
    },
    {
      ...
      slug: "/productos/capuchas-para-bomberos/forestal",
      badge: "NFPA 1977",
      badgeColor: "fire",
      imagen: null,
      placeholderPaths: [
  ...
  return renderTemplate`${renderComponent($$result, "PageLayout", $$PageLayout, { "title": "Capuchas y Monjas para Bomberos NFPA | Nomex\xAE, PBI Gold\xAE y Particulada | BOMBERO.MX", "description": "Capuchas y monjas para bombero certificadas NFPA 1971 y 1977. Nomex\xAE estructural, PBI Gold\xAE premium, particulada anti-carcin\xF3genos y forestal. Env\xEDo a los 32 estados. \xA1Cotiza ahora!", "keywords": [
...
En <strong data-astro-cid-vvfg7ie7>BOMBERO.MX</strong> verificamos la compatibilidad de todo el EPP antes de la entrega. Proveemos trajes, cascos, guantes, botas y SCBA certificados NFPA con asesoría técnica sin costo y disponibilidad inmediata para los <strong data-astro-cid-vvfg7ie7>32 estados de México</strong>.
  ...
  ], "data-astro-cid-vvfg7ie7": true })} ${renderComponent($$result2, "CategoryCard", $$CategoryCard, { "title": "Trajes de Bombero", "icon": "shield", "image": "/images/directorio/traje-bombero-estructural-nfpa-01.avif", "href": "/productos/trajes-para-bomberos", "buttonText": "Trajes para Bombero", "items": [
  ...
  ], "data-astro-cid-vvfg7ie7": true })} ${renderComponent($$result2, "CategoryCard", $$CategoryCard, { "title": "Equipos SCBA", "icon": "shield", "href": "/productos/scba", "buttonText": "Equipos SCBA", "items": [
