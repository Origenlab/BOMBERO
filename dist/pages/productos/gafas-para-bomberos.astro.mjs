...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PageLayout", $$PageLayout, { "title": "Gafas y Protecci\xF3n Visual para Bomberos | Goggle NFPA 1971, ANSI Z87.1 | BOMBERO.MX", "description": "Gafas y goggles para bombero certificados NFPA 1971 y ANSI Z87.1. Goggle sellado antiimpacto y gafas de seguridad para rescate. Env\xEDo a los 32 estados de M\xE9xico. \xA1Cotiza ahora!", "keywords": [
    "gafas para bomberos",
...
En <strong data-astro-cid-w6um6f3c>BOMBERO.MX</strong> verificamos la compatibilidad del EPP completo antes de la entrega. Proveemos cascos, capuchas, trajes y SCBA certificados NFPA con asesoría técnica sin costo y disponibilidad inmediata para los <strong data-astro-cid-w6um6f3c>32 estados de México</strong>.
    ...
    { label: "Capucha Forestal NFPA 1977", href: "/productos/capuchas-para-bomberos/forestal" }
  ], "data-astro-cid-w6um6f3c": true })} ${renderComponent($$result2, "CategoryCard", $$CategoryCard, { "title": "Trajes de Bombero", "icon": "shield", "image": "/images/directorio/traje-bombero-estructural-nfpa-01.avif", "href": "/productos/trajes-para-bomberos", "buttonText": "Trajes para Bombero", "items": [
  ...
  ], "data-astro-cid-w6um6f3c": true })} ${renderComponent($$result2, "CategoryCard", $$CategoryCard, { "title": "Equipos SCBA", "icon": "shield", "href": "/productos/scba", "buttonText": "Equipos SCBA", "items": [
