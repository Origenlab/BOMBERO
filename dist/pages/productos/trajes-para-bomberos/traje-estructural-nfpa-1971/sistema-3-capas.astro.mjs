...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ProductoLayout", $$ProductoLayout, { "title": "Traje Estructural NFPA 1971 \u2014 Sistema 3 Capas | BOMBERO.MX", "description": "Traje estructural NFPA 1971 Sistema 3 Capas certificado. Capa exterior Nomex\xAE, barrera Gore-Tex\xAE y liner t\xE9rmico TPP \u2265 35 cal/cm\xB2. Ficha t\xE9cnica incluida. Env\xEDo a los 32 estados de M\xE9xico.", "keywords": [
    ...
    { src: "/images/directorio/traje-bombero-estructural-nfpa-01.avif", alt: "Traje estructural NFPA 1971 sistema 3 capas" },
    { src: "/images/directorio/bomberos-emergencia-incendio-estructural-01.avif", alt: "Bombero con traje estructural en incendio" },
    { src: "/images/directorio/bomberos-accion-incendio-01.avif", alt: "Bomberos en acci\xF3n con traje NFPA 1971" },
    ...
    { src: "/images/directorio/entrenamiento-bomberos-fuego-01.avif", alt: "Entrenamiento con traje estructural" }
