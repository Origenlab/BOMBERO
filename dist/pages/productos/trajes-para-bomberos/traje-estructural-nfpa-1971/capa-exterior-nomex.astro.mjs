...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const IMAGE = "/images/trajes-para-bombero/traje-bombero-estructural-nfpa-1971-modelo-frontal-02.avif";
  const capas = [
    {
      num: "01",
  ...
  return renderTemplate`${renderComponent($$result, "ProductoLayout", $$ProductoLayout, { "title": "Capa Exterior Nomex\xAE NFPA 1971 \u2014 Tejido Ign\xEDfugo | BOMBERO.MX", "description": "Capa exterior Nomex\xAE IIIA y Nomex\xAE Nano certificada NFPA 1971. Resistencia inherente a la llama ASTM D6413: no arde, no se derrite, no encoge. Ficha t\xE9cnica incluida. Env\xEDo a los 32 estados de M\xE9xico.", "keywords": [
    ...
    { src: "/images/trajes-para-bombero/traje-bombero-estructural-nfpa-1971-modelo-frontal-02.avif", alt: "Capa exterior Nomex\xAE NFPA 1971" },
    { src: "/images/trajes-para-bombero/traje-bombero-estructural-nfpa-1971-modelo-frontal-05.avif", alt: "Bombero con traje Nomex estructural vista frontal" },
    { src: "/images/trajes-para-bombero/bunker-gear-bombero-estacion-vista-frontal-trasera-01.avif", alt: "Bunker gear bombero vista frontal y trasera" },
    { src: "/images/trajes-para-bombero/traje-bombero-estructural-nfpa-1971-modelo-frontal-07.avif", alt: "Bomberos profesionales con capa Nomex" },
    { src: "/images/trajes-para-bombero/traje-bombero-estructural-sin-modelo-flatlay-01.avif", alt: "Traje bombero estructural completo sin modelo" },
    { src: "/images/trajes-para-bombero/bombera-profesional-traje-estructural-estacion-01.avif", alt: "Bombera profesional con traje Nomex certificado" }
