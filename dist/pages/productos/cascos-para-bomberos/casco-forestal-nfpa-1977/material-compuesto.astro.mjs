...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const epp = [
    ...
    { label: "Gafas/Goggles Forestales", href: "/productos/gafas", tag: "Ojos" },
  ...
  const articulos = [
    ...
    { label: "Vida \xDAtil del EPP Forestal", href: "/productos", tag: "Gu\xEDa" },
    { label: "Brigadas CONAFOR Equipamiento", href: "/productos", tag: "Normativa" }
  ];
  ...
  return renderTemplate`${renderComponent($$result, "ProductoLayout", $$ProductoLayout, { "title": "Casco Forestal NFPA 1977 \u2014 Material Compuesto Fibra de Vidrio | BOMBERO.MX", "description": "Casco forestal NFPA 1977 material compuesto. Shell de fibra de vidrio + resina fen\xF3lica, suspensi\xF3n 6 puntos, vida \xFAtil 10 a\xF1os. Para brigadas de alta actividad CONAFOR. Env\xEDo a los 32 estados de M\xE9xico.", "keywords": [
