...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const articulos = [
    ...
    { label: "Normativa CONAFOR", href: "/productos", tag: "Normativa" },
    { label: "Guantes para Trabajo Forestal", href: "/productos/guantes/forestales", tag: "Cat\xE1logo" },
    { label: "Botas Logger y Forestales", href: "/productos/botas/forestal", tag: "Cat\xE1logo" }
  ];
