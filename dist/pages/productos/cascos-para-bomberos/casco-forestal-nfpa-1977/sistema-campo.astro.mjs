...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const epp = [
    ...
    { label: "Radio Comunicaci\xF3n", href: "/productos", tag: "Comunicaci\xF3n" }
  ];
  const articulos = [
    { label: "Cat\xE1logo Cascos Forestales", href: "/productos/cascos-para-bomberos/casco-forestal-nfpa-1977", tag: "Cat\xE1logo" },
    { label: "Equipamiento de Brigadas", href: "/productos", tag: "Gu\xEDa" },
    { label: "Licitaciones CONAFOR", href: "/productos", tag: "Normativa" },
    { label: "EPP Forestal Completo NFPA 1977", href: "/productos/trajes-para-bomberos/traje-forestal-nfpa-1977", tag: "Sistema" },
    { label: "Control de Inventario EPP", href: "/productos", tag: "Art\xEDculo" },
    { label: "Mantenimiento de Cascos", href: "/productos", tag: "Gu\xEDa" }
  ];
