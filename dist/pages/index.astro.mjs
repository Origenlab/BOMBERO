import { c as createComponent, m as maybeRenderHead, r as renderComponent, d as addAttribute, a as renderTemplate } from '../chunks/astro/server_DiGDuMOy.mjs';
import 'piccolore';
import { $ as $$PageLayout } from '../chunks/PageLayout_C3xQZUfp.mjs';
import { $ as $$Certifications } from '../chunks/Certifications_CdNIFzsk.mjs';
...
Nuestro <strong data-astro-cid-j7pv25f6>equipo EPP para bomberos</strong> incluye trajes estructurales, forestales y HAZMAT, cascos de última generación, botas resistentes al calor, guantes de extricación y protección respiratoria. Trabajamos con estaciones de bomberos, protección civil y brigadas industriales en los <strong data-astro-cid-j7pv25f6>32 estados de la República Mexicana</strong>.
</p> ` })} <!-- EPP Categories Grid --> <div class="epp__grid" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "CategoryCard", $$CategoryCard, { "title": "Trajes de Bombero", "badge": "5 productos", "icon": "shield", "href": "/productos/trajes-para-bomberos", "buttonText": "Trajes para Bomberos", "items": [
    ...
    { label: "Traje de Aproximaci\xF3n", href: "/productos/trajes-para-bomberos/aproximacion" },
    { label: "Traje HAZMAT", href: "/productos/trajes-para-bomberos/hazmat" }
  ], "data-astro-cid-j7pv25f6": true })} ${renderComponent($$result2, "CategoryCard", $$CategoryCard, { "title": "Cascos", "badge": "4 productos", "icon": "helmet", "href": "/productos/cascos-para-bomberos", "buttonText": "Cascos para Bomberos", "items": [
    { label: "Casco Estructural", href: "/productos/cascos-para-bomberos/estructural" },
    { label: "Casco Forestal", href: "/productos/cascos-para-bomberos/forestal" },
    { label: "Casco de Rescate", href: "/productos/cascos-para-bomberos/rescate" },
