...
export const YUCATAN_SEO = {
  ...
  poblacion: 2_320_898,
  superficie_km2: 39_612,
  municipios: 106,
  patrimonio_mundial: '2 sitios UNESCO (Chichén Itzá, Uxmal)',
};

export const ESTADISTICAS_YUCATAN = {
  total_estaciones: 18,
  total_bomberos: 620,
  total_unidades: 72,
  municipios_cubiertos: 18,
};

export const estacionesYucatan: Estacion[] = [
  {
  ...
  },
  {
    ...
    coordenadas: { lat: 20.9280, lng: -89.7210 },
  },
  {
    id: "yuc-merida-sur",
    slug: "yuc-merida-sur",
    ...
    coordenadas: { lat: 20.9205, lng: -89.6450 },
  },
  {
    id: "yuc-kanasin",
    slug: "yuc-kanasin",
  ...
  },
  {
    ...
    coordenadas: { lat: 20.8860, lng: -89.7570 },
  },
  {
    id: "yuc-progreso",
    slug: "yuc-progreso",
  ...
  },
  {
    ...
    personalActivo: 35,
    tiempoRespuesta: "6-10 minutos",
    coordenadas: { lat: 20.6900, lng: -88.2023 },
  },
  {
    id: "yuc-chichen-itza",
  ...
  },
  {
    ...
    coordenadas: { lat: 21.1430, lng: -88.1645 },
  },
  {
    id: "yuc-izamal",
    slug: "yuc-izamal",
  ...
  },
  {
    ...
    coordenadas: { lat: 21.0960, lng: -89.2863 },
  },
  {
    id: "yuc-ticul",
    slug: "yuc-ticul",
    ...
    personalActivo: 25,
    tiempoRespuesta: "8-13 minutos",
    coordenadas: { lat: 20.3930, lng: -89.5296 },
  },
  {
    id: "yuc-oxkutzcab",
    slug: "yuc-oxkutzcab",
  ...
  // ─── CELESTÚN (Reserva Biósfera — Costa Oeste) ──────────────────────────────────────
  {
    ...
    horario: "24 horas / 365 días",
    coordenadas: { lat: 20.8614, lng: -90.3990 },
  ...
  // ─── RÍO LAGARTOS (Reserva Biósfera — Costa Norte) ──────────────────────────────────────
  {
    ...
    horario: "24 horas / 365 días",
    coordenadas: { lat: 21.5940, lng: -88.1660 },
...
export function getEstacionesByMunicipio(municipio: string): Estacion[] {
  return estacionesYucatan.filter((e) => e.municipio === municipio);
}

export function getMunicipios(): string[] {
  return [...new Set(estacionesYucatan.map((e) => e.municipio).filter((v): v is string => v !== undefined))];
}
