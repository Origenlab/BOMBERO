...
export const TLAXCALA_SEO = {
  estado: 'Tlaxcala',
  estadoCorto: 'Tlaxcala',
  codigo: 'TLA',
  capital: 'Tlaxcala de Xicohténcatl',
  gentilicio: 'tlaxcalteca',
  region: 'Centro de México',
  poblacion: 1_342_977,
  superficie_km2: 3_991,
  municipios: 60,
  densidad_industrial: 'Mayor concentración de parques industriales por km² de México',
};

export const ESTADISTICAS_TLAXCALA = {
  total_estaciones: 15,
  total_bomberos: 520,
  total_unidades: 58,
...
export const estacionesTlaxcala: Estacion[] = [
...
export function getEstacionesByMunicipio(municipio: string): Estacion[] {
  return estacionesTlaxcala.filter(e => e.municipio === municipio);
}
