...
export const TAMAULIPAS_SEO = {
  estado: 'Tamaulipas',
  estadoCorto: 'Tamaulipas',
  codigo: 'TAM',
  capital: 'Ciudad Victoria',
  gentilicio: 'tamaulipeco',
  region: 'Noreste de México',
  poblacion: 3_527_735,
  superficie_km2: 79_829,
  municipios: 43,
};

export const ESTADISTICAS_TAMAULIPAS = {
  total_estaciones: 20,
  total_bomberos: 960,
  total_unidades: 112,
...
export const estacionesTamaulipas: Estacion[] = [
  ...
  // ─── RÍO BRAVO (Valle Bajo del Río Bravo / Agrícola) ─────────────────────────
  {
    ...
    horario: "24 horas",
    coordenadas: { lat: 26.0000, lng: -98.0833 },
  ...
  // ─── SAN FERNANDO (Corredor Carretero / Ganadería) ───────────────────────────
  {
    ...
    horario: "24 horas",
    coordenadas: { lat: 24.8500, lng: -98.1500 },
  ...
  // ─── CIUDAD MANTE (Agroindustria Azucarera) ──────────────────────────────────
  {
    ...
    horario: "24 horas",
    coordenadas: { lat: 22.7400, lng: -98.9700 },
  ...
  // ─── CIUDAD VICTORIA NORTE (Zona Industrial) ─────────────────────────────────
  {
    ...
    horario: "24 horas",
    coordenadas: { lat: 23.7600, lng: -99.1200 },
...
export function getEstacionesByMunicipio(municipio: string): Estacion[] {
  return estacionesTamaulipas.filter(e => e.municipio === municipio);
}

export function getMunicipios(): string[] {
  return [...new Set(estacionesTamaulipas.map(e => e.municipio).filter((v): v is string => v !== undefined))];
}
