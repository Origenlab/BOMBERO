/**
 * Serie editorial: Trajes para Bomberos — Artículo 1
 * Comparativa técnica de materiales (Nomex® vs PBI Gold® y otros)
 * Categoría: Equipo — orientado a venta consultiva del servicio de trajes
 */

import type { ArticuloData } from "./blog-articulos";

export const slug = "traje-bombero-nomex-vs-pbi-materiales";
...
export const articulo: ArticuloData = {
  ...
  heroSeoBlocks: [
    ...
    },
    {
      ...
      text: "TPP, THL, barrera de humedad y barrera térmica son los parámetros que separan una buena adquisición de un gasto mal invertido. Esta guía traduce la especificación técnica a una <strong>decisión de compra clara</strong>. ¿Listo para definir tu requerimiento? <a href=\"/cotizar/\">Solicita una cotización asesorada</a>.",
    },
  ],
  contenido: `
...
La barrera de humedad es, además, el componente que más sufre con un mantenimiento deficiente. Por eso la elección del material va de la mano del protocolo de cuidado: lo desarrollamos en nuestra guía de [mantenimiento y vida útil del traje](/blog/mantenimiento-vida-util-traje-bombero/).
