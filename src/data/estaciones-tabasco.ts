...
export const TABASCO_SEO = {
  estado: 'Tabasco',
  estadoCorto: 'Tabasco',
  codigo: 'TAB',
  capital: 'Villahermosa',
  gentilicio: 'tabasqueño',
  region: 'Sureste de México',
  poblacion: 2_402_461,
  superficie_km2: 24_661,
  municipios: 17,
};

export const ESTADISTICAS_TABASCO = {
  total_estaciones: 17,
  total_bomberos: 680,
  total_unidades: 78,
...
export const estacionesTabasco: Estacion[] = [
...
export function getEstacionesByMunicipio(municipio: string): Estacion[] {
  return estacionesTabasco.filter(e => e.municipio === municipio);
}

export function getMunicipios(): string[] {
  return [...new Set(estacionesTabasco.map(e => e.municipio).filter((v): v is string => v !== undefined))];
}
