...
export const estacionesCampeche: Estacion[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    horario: "24 horas, 365 días del año",
    coordenadas: { lat: 18.6510, lng: -91.8305 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    horario: "24 horas, 365 días del año",
    coordenadas: { lat: 18.1833, lng: -91.0500 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    horario: "24 horas, 365 días del año",
    coordenadas: { lat: 18.5181, lng: -89.4200 },
...
export function getEstacionesCercanas(slug: string, limit: number = 3): Estacion[] {
  ...
  // Priorizar estaciones del mismo municipio
...
export function getEstacionesHAZMAT(): Estacion[] {
  return estacionesCampeche.filter(
    (e) =>
      ...
      e.unidadesDisponibles?.some((u) => u.toLowerCase().includes("hazmat"))
  );
}
...
export function getEstacionesForestales(): Estacion[] {
  return estacionesCampeche.filter(
    (e) =>
      ...
      e.unidadesDisponibles?.some((u) => u.toLowerCase().includes("forestal"))
  );
}
    ...
    (e) =>
      e.servicios.some(
        (s) =>
          ...
          s.toLowerCase().includes("fluvial")
      ) ||
      e.unidadesDisponibles?.some(
        (u) =>
          u.toLowerCase().includes("lancha") ||
          u.toLowerCase().includes("acuática")
      )
  );
}
