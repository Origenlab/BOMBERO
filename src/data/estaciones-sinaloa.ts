...
export const SINALOA_SEO = {
  ...
  poblacion: 3_026_943,
  superficie_km2: 58_328,
  municipios: 18,
};

export const ESTADISTICAS_SINALOA = {
  total_estaciones: 20,
  total_bomberos: 850,
  total_unidades: 95,
...
export const estacionesSinaloa: Estacion[] = [
  {
...
export function getEstacionesByMunicipio(municipio: string): Estacion[] {
  return estacionesSinaloa.filter(e => e.municipio === municipio);
}
